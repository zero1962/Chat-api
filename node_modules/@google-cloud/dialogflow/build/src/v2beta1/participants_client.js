...
class ParticipantsClient {
    ...
    initialize() {
        ...
        const participantsStubMethods = ['createParticipant', 'getParticipant', 'listParticipants', 'updateParticipant', 'analyzeContent', 'streamingAnalyzeContent', 'suggestArticles', 'suggestFaqAnswers', 'suggestSmartReplies', 'suggestKnowledgeAssist', 'listSuggestions', 'compileSuggestion'];
